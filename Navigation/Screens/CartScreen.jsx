...
const CartScreen = () => {
  ...
  const increaseQuantity = async (productId, id) => {
    ...
    try {
      const data = await fetch(
        `https://rento-mojo-native-server.vercel.app/cartarr/${id}`,
        {}
      );
  ...
  return (
    <>
      <Text onPress={() => sendToCheckout()} style={styles.totalPriceDiv}>
        {isAuth
        ...
        {usercart.length == 0 ? (
          <View style={styles.emptycartImg}>
            ...
            <Image
              ...
              source={{
                uri: `https://www.rentomojo.com/public/images/error/no-cart.png`,
              }}
            />
          </View>
        ) : null}
