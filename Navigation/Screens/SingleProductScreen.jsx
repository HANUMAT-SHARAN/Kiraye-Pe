...
const SingleProductScreen = ({route}) => {
  ...
  const [value,setValue]=useState(8)
      ...
      const getData=async()=>{
        try {
          let data=await fetch(`https://rento-mojo-native-server.vercel.app/electronics/${id}`)
  ...
  return (
    <ScrollView>
      ...
      <View style={styles.pricediv}>
        <Text style={styles.priceText}> ₹ {value>=12?price/2:price} / Month</Text>
      ...
      <View
        style={{
          ...
          alignItems: "center",
          width: "60%",
          marginLeft:5,          justifyContent: "space-around",
          padding:10,
      ...
      <View style={styles.sliderDiv}>
        ...
        <Slider animationType="spring" allowTouchTrack={true}   maximumValue={12}
        minimumValue={4}
        step={4}
        thumbTintColor="red"
        value={value}
